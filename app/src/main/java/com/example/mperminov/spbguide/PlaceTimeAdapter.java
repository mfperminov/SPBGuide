...
/**
 * Custom adapter for Place object with working hours specified
 */

public class PlaceTimeAdapter extends ArrayAdapter<Place> {
    public PlaceTimeAdapter(Activity context, ArrayList<Place> wordList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        daysUntilTv.setText(currentPlace.getmWorkingHours());
        return listItemView;
    }
}
